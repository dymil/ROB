...
public:
  ...
  vector<int>* clause_helper(vector<pair<bool,string> > *clause, vector<int> *satisfied,
  ...
  vector<int> next_clause(vector<vector<pair<bool,string> > > *formula, vector<int> *prev_set, int curr) {
  ...
  vector<int> first_clause(vector<vector<pair<bool,string> > > *formula) {
