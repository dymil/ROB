...
vector<int>* Index::clause_helper(vector<pair<bool,string> > *clause, vector<int> *satisfied,
  vector<int> *not_satisfied, int curr_index) {
...
vector<int> Index::next_clause(vector<vector<pair<bool,string> > > *formula, vector<int> *prev_set, int curr) {
...
vector<int> Index::first_clause(vector<vector<pair<bool,string> > > *formula) {
